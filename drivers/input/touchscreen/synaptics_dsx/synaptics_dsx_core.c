...
#define ABS_X_MAX 1080	//add by qiyei2009
#define ABS_Y_MAX 1920	//add by qiyei2009
#define PRESS_MAX 255	//add by qiyei2009
		...
		struct synaptics_rmi4_fn *fhandler)
{
	...
	for (finger = 0; finger < fingers_supported; finger++) {
		...
		if (finger_status) {
			...
			input_report_key(rmi4_data->input_dev,
					BTN_TOOL_FINGER, 1);
			//printk(KERN_ERR"%s %s %d;data_reg_blk_size = %d\n",__FILE__,__FUNCTION__,__LINE__,data_reg_blk_size); //add by qiyei2009

//			input_report_abs(rmi4_data->input_dev,
//					ABS_MT_POSITION_X, x);
//			input_report_abs(rmi4_data->input_dev,
//					ABS_MT_POSITION_Y, y);
			input_report_abs(rmi4_data->input_dev, ABS_X, x);//add by qiyei2009
			input_report_abs(rmi4_data->input_dev, ABS_Y, y);//add by qiyei2009	
			input_report_abs(rmi4_data->input_dev, ABS_PRESSURE,pressure); //add by qiyei2009
#ifdef REPORT_2D_W
//			input_report_abs(rmi4_data->input_dev,
...
//	printk(KERN_ERR"%s %s %d;x= %d y= %d ts_count= %d \n",__FILE__,__FUNCTION__,__LINE__,x,y,touch_count); //add by qiyei2009
...
//					ABS_MT_POSITION_Y, y);
			input_report_abs(rmi4_data->input_dev, ABS_X, x);//add by qiyei2009
			input_report_abs(rmi4_data->input_dev, ABS_Y, y);//add by qiyei2009	
			input_report_abs(rmi4_data->input_dev,  ABS_PRESSURE,  1); //add by qiyei2009
		...
		struct synaptics_rmi4_fn *fhandler)
{
	...
	case SYNAPTICS_RMI4_F11:
		touch_count_2d = synaptics_rmi4_f11_abs_report(rmi4_data,
				fhandler);
//		printk(KERN_ERR"%s %s %d \n",__FILE__,__FUNCTION__,__LINE__); //add by qiyei2009
		if (touch_count_2d)
...
static void synaptics_rmi4_set_params(struct synaptics_rmi4_data *rmi4_data)
{
	...
	rmi = &(rmi4_data->rmi4_mod_info);
	input_set_abs_params(rmi4_data->input_dev,  ABS_PRESSURE,  0,  PRESS_MAX,  0,  0); 	//add by qiyei2009
	input_set_abs_params(rmi4_data->input_dev, ABS_X, 0,  ABS_X_MAX, 0, 0);		//add by qiyei2009
	input_set_abs_params(rmi4_data->input_dev, ABS_Y, 0,  ABS_Y_MAX, 0, 0);	//add by qiyei2009
